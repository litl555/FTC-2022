...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 1.5+3.3; // X is the up and down direction
    public static double PARALLEL_Y = 6.43; // Y is the strafe direction

    public static double PERPENDICULAR_X = -5.94488;
    public static double PERPENDICULAR_Y = -0.944882;
