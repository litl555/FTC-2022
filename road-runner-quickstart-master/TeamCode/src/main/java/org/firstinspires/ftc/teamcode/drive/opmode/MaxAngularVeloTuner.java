...
public class MaxAngularVeloTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && timer.seconds() < RUNTIME) {
            ...
            drive.testFunc();
            //telemetry.addData("pose velocity from drive", drive.testVar);
            //telemetry.addData("pose velocity from script", drive.testVar);
            telemetry.addData("Max dist: ", maxAngVelocity);
            telemetry.update();
        }
